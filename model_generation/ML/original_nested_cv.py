...
if __name__ == '__main__':          
    ...
    for trainval,test in k_fold.split(X,y):
        ...
        k_fold_2 = StratifiedKFold(n_splits=5, shuffle=True)
        ...
        param_grid = {"max_depth": [15,13,11,9,5,3,2,None],
          "max_features": ['auto',20,25,30,40,80,100],
          "min_samples_split": [2,3,5,7,10,15,20,30,40],
          "criterion": ["gini"]}
        """
        
        
        param_grid = {"max_depth": [None],
          "max_features": ['auto',30],
        ...
        print('FOLD',str(cnt),"Accuracy : %0.2f (+/- %0.2f)" % (grid_search.cv_results_['mean_test_score'].mean(), 
                                               grid_search.cv_results_['mean_test_score'].std() * 2))
